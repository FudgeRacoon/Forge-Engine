...
namespace Forge {
	namespace Graphics
	{
		...
		public:
			 ...
			 */
			virtual ~GLHardwareIndexBuffer(Void) = default;
		...
		FORGE_FORCE_INLINE GLHardwareIndexBuffer::GLHardwareIndexBuffer(ValueTypeMask index_type_mask, Size index_count,
																		UsageModeMask usage_mode_mask, Bool is_shadowed)
			: GLHardwareBuffer(GL_ELEMENT_ARRAY_BUFFER, 0, usage_mode_mask, is_shadowed), m_index_count(index_count)
		{
